...
# 
# Includes build rules for arith and ppmdiff.c
#
...
40image-6: 40image.o compress40.o read_write.o a2plain.o a2blocked.o uarray2.o \
uarray2b.o rgb_cv_converter.o luma_cos_converter.o bitpack.o codewords.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

test: main_test.o read_write.o a2plain.o a2blocked.o uarray2.o uarray2b.o \
rgb_cv_converter.o luma_cos_converter.o bitpack.o codewords.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

clean:
	rm -f ppmdiff test arith
